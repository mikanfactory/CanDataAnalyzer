...
f = open('HQL_sample_accel_break.kml','w')
f.write('<?xml version="1.0" encoding="UTF-8" standalone="no"?>\n')
f.write('<kml xmlns="http://earth.google.com/kml/2.2">n')
f.write('<Document>\n')
f.write('<Style id="emp">\n <IconStyle>\n <scale>0.8</scale>\n <Icon>\n <href>empty.png</href>\n </Icon>\n </IconStyle>\n </Style>\n')
f.write('<Style id="up">\n <IconStyle>\n <scale>0.8</scale>\n <Icon>\n <href>up.png</href>\n </Icon>\n </IconStyle>\n </Style>\n')
f.write('<Style id="down">\n <IconStyle>\n <scale>0.8</scale>\n <Icon>\n <href>down.png</href>\n </Icon>\n </IconStyle>\n </Style>\n')
f.write('\n')
...
for i in xrange(1,N):
    ...
    f.write('</coordinates>\n </Point>')
    if ave_acc_pdl[i]>5:
        f.write('<styleUrl>up</styleUrl>\n </Placemark>\n')
    elif ave_br_pdl[i]>5:
        f.write('<styleUrl>down</styleUrl>\n </Placemark>\n')
    else:
        f.write('<styleUrl>emp</styleUrl>\n </Placemark>\n')
f.write('</Document>\n </kml>\n')
f.close()
